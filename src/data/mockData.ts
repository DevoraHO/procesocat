...
export const mockBadges = [
  ...
  { id:'veterà', name_es:'Veterano', name_ca:'Veterà', icon:'🎗️', category:'especial', rarity:'rar', rarity_color:'#3b82f6', earned:false, points_bonus:1000, requirement_es:'1 año de antigüedad en ProcesoAlert', requirement_ca:'1 any d\'antiguitat a ProcesoAlert', progress:75, total:365, motivator_es:'Llevas 75 días — te faltan 290 días', motivator_ca:'Portes 75 dies — et falten 290 dies' },
  { id:'dos_anys', name_es:'Dos Años', name_ca:'Dos Anys', icon:'🔱', category:'especial', rarity:'llegenda', rarity_color:'#f59e0b', earned:false, points_bonus:3000, requirement_es:'2 años de antigüedad en ProcesoAlert', requirement_ca:'2 anys d\'antiguitat a ProcesoAlert', progress:75, total:730, motivator_es:'Solo los más fieles llegan a 2 años', motivator_ca:'Només els més fidels arriben a 2 anys' },
  ...
  { id:'enllaç_institucional', name_es:'Enlace Institucional', name_ca:'Enllaç Institucional', icon:'🏛️', category:'especial', rarity:'llegenda', rarity_color:'#f59e0b', earned:false, points_bonus:5000, requirement_es:'Refiere un municipio al Plan Municipi', requirement_ca:'Refereix un municipi al Pla Municipi', progress:0, total:1, motivator_es:'Contacta con tu ayuntamiento sobre ProcesoAlert', motivator_ca:'Contacta amb el teu ajuntament sobre ProcesoAlert' }
];
